...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--patch_size', type=list, default=[128, 128, 64])
        self.parser.add_argument('--ninput_edges', type=int, default=3000,
        ...
        self.parser.add_argument('--input_nc', type=int, default=100,
